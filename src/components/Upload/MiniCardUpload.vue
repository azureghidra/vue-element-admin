<template>
  <div>
    ...
    >
      ...
      <i v-else class="el-icon-plus mini-card-uploader-icon" />
      <i v-if="fileList[0].url" class="el-icon-close mini-card-remove-icon" @click.stop="handleRemove(fileList[0].url)" />
    </el-upload>
